...
for dataset in "cifar-10-grey-animal-vehicle-intermediate-small-equal-close-global-cluster-kmeans-5"
do
    for model in "dllp"
    do
        for loss in "abs"
...
for dataset in "cifar-10-grey-animal-vehicle-naive-small-not-equal-None-cluster-None-None" 
do
    for model in "dllp"
    do
        for loss in "abs"
...
for dataset in "cifar-10-grey-animal-vehicle-simple-small-not-equal-close-global-cluster-None-None" 
do
    for model in "dllp"
    do
        for loss in "abs"
...
for dataset in "cifar-10-grey-animal-vehicle-hard-small-equal-close-global-cluster-kmeans-5" 
do
    for model in "dllp"
    do
        for loss in "abs"
...
for dataset in "cifar-10-grey-animal-vehicle-hard-small-not-equal-close-global-cluster-kmeans-5" 
do
    for model in "dllp"
    do
        for loss in "abs"
